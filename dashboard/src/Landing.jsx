...
const SCANIVERSE_STEPS = [
  ...
  ["02", "Onboard & Import Scan", "Open the ScanBorn dashboard, set up your project workspace, and drag-and-drop your exported Scaniverse 3D file.", "User Action: Workspace Onboarding → Upload Scan"],
      ...
      <section className="band band--start" id="start" ref={startRef}>
        ...
        <div className="band__body">
          ...
          <pre className="code" data-reveal>
            <code>
              <span className="c-k">from</span> scanborn <span className="c-k">import</span> ScanBorn
              {"\n\n"}
              tf = ScanBorn(<span className="c-s">"http://localhost:8000"</span>)
              {"\n"}
