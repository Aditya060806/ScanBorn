...
The job to be done: understand what ScanBorn does, decide whether it is real, and then
be able to run the loop.

## Product Purpose

ScanBorn is an edge-first Physical AI operating layer. Point a phone at a space and get a
