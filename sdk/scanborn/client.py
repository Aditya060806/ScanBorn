"""ScanBorn Python SDK — one method per orchestrator endpoint (blueprint section 19)."""
import io
import json
...
class ScanBornError(RuntimeError):
...
class ScanBorn:
    ...
    against the app in-process with no socket:
        ScanBorn(http=fastapi.testclient.TestClient(app))
    """
